...
public class ExtenderConfigs {
    ...
    static {
        ...
        // Invert the follower motor's direction relative to the leader if the leader is not inverted,
        // or keep it in the same direction if the leader is inverted. This ensures both motors
        // move in the same physical direction.
        followConfig.inverted(!leaderInverted); 

        // Disable soft limits for the follower motor as they are managed by the leader
        // or through the subsystem's logic during independent control.
        ...
        // Disable soft limits for homing, allowing the extender to reach a mechanical stop.
